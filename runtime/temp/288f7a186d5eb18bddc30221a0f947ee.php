<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\xampp\htdocs\tp5\public/../application/admin\view\slides\index.html";i:1495876559;s:49:"../application/admin/view/public/adminHeader.html";i:1495869518;s:49:"../application/admin/view/public/adminFooter.html";i:1479798781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="x_panel">
      <div class="x_content">
        <table class="table table-bordered" cellspacing="0" cellpadding="0" width="100%">
          ...
          <tbody>
          <?php if(is_array($slides) || $slides instanceof \think\Collection): $i = 0; $__LIST__ = $slides;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slide): $mod = ($i % 2 );++$i;?>
          <tr>
            <td><span><?php echo $slide['slide_id']; ?></span></td>
            <td><?php echo $slide['slide_title']; ?></td>
            <td><?php echo $slide['slide_link']; ?></td>
            <td><img src="/<?php echo $slide['slide_src']; ?>" style="max-width: 120px;" /></td>
            <td><a href="editSlide?slide_id=<?php echo $slide['slide_id']; ?>">编辑</a>  <button>删除</button></td>
          </tr>
